...
<template>
  <div class="relative">
    <div class="relative z-10 container mx-auto px-4 md:px-0">
          ...
          >
            ...
            <div class="flex justify-between items-center">
              <div class="w-1/3 text-center">
                ...
                <p class="text-[#9A9BA4] md:text-mainColor text-xs md:text-2xl">
                  Врачей
                </p>
              </div>
              <div class="block w-[3px] md:w-[5px] bg-mainColor h-[78px]"></div>
              <div class="w-1/3 text-center">
