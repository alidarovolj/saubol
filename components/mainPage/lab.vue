  ...
  <div class="container mx-auto px-4 lg:px-0">
    <div class="flex flex-col lg:flex-row">
      <div class="w-full rounded-2xl">
        <div class="relative rounded-2xl px-4 lg:px-20">
          <img
...
<!--          <div class="setBg absolute left-0 top-0 w-full h-full rounded-2xl"></div>-->
          <div class="relative z-20 rounded-2xl">
            ...
            <h2 class=" text-xl lg:text-4xl text-mainColor font-semibold mb-4">
              Домо-Лаб
            </h2>
...
<!--                  </div>-->
            ...
            <div class="pt-4 pb-0 lg:pb-10">
              <p class="text-sm lg:text-xl font-medium text-mainColor">
                Удобно и без лишних хлопот: сдавайте анализы на дому! Наша услуга позволяет вам избежать очередей и
                походов в клиники. Профессиональные медицинские работники приедут к вам в удобное время, возьмут
                необходимые образцы и доставят их в аккредитованную лабораторию. Получите результаты быстро и
...
.setBg {
  border-radius: 15px;
  background: linear-gradient(90deg, #fff -26.72%, rgba(25, 107, 247, 0.00) 181.78%);
}
</style>