  ...
  <section class="pt-[30px]">
    <div class="container mx-auto px-4 md:px-4">
      ...
      <div class="block md:flex justify-between items-start">
        <div
          class="md:mr-6 mb-6 md:mb-0 p-6 bg-white shadow-lg rounded-lg w-full md:w-2/3"
        >
          <div v-if="resultDetail">
            ...
            <div class="text-sm">
              ...
              />
              <div class="checkLinks news-details">
        ...
        <div class="w-full md:w-1/3">
          <p class="text-base font-bold mb-4">Читайте также:</p>
          <div v-if="result" class="py-0">
            ...
            >
              ...
              <div class="flex items-center justify-between font-semibold my-2">
                ...
                <IconArrowRight class="w-max mr-0 !text-black" size="20" />
              </div>
              <p
                class="news-list !text-sm text-start line-clamp-4 mb-2 h-20 max-h-20 !text-black"
                v-html="item.content.slice(0, 100) + '...'"
              ></p>
