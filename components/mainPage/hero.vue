    ...
    <div class="container mx-auto px-4 md:px-0 relative z-10">
      <div class="block md:flex justify-between py-9 md:py-36 md:pb-0">
        <div class="w-full md:w-1/2 mb-20 md:mb-0">
          <div class="text-3xl md:text-6xl font-semibold md:font-normal mb-7 md:mb-24">
          ...
          <p class="mb-6 text-base md:text-2xl w-full md:w-3/4 text-center md:text-start">
          ...
          <div class="w-full flex flex-row md:flex-col gap-6">
            <div class="w-full">
              <NuxtLink
                ...
                <div class="cardBlock bg-[#FEAA48] p-2 md:p-4 rounded-lg text-white absolute">
            ...
            <div class="w-full">
              <NuxtLink
                ...
                <div class="cardBlock bg-[#0065FF] p-2 md:p-4 rounded-lg text-white absolute">
          ...
          <div class="w-full flex flex-row md:flex-col gap-6 mt-0">
            <div class="w-full">
              <NuxtLink
                ...
                <div class="cardBlock bg-[#FD586B] p-2 md:p-4 rounded-lg text-white absolute">
