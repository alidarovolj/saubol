...
<template>
  <div class="py-10 mb-20">
    <div class="container mx-auto px-4 md:px-0">
      <div class="bg-[#F7FAFF] p-4 md:p-7 rounded-3xl">
        <div class="block md:flex items-center">
          <div class="w-full md:w-1/2 mb-10 md:mb-0">
            ...
            <p class="text-sm my-9">
              Наслаждайтесь уникальными преимуществами нашего
              персонализированного подхода к вашему здоровью. Мы стремимся к
              вашему комфорту и благополучию, предлагая индивидуальные решения,
