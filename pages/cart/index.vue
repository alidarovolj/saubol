  ...
  <div class="pt-8">
    <div class="container mx-auto px-4 lg:px-0">
      ...
      <div class="block lg:flex items-start justify-between gap-5">
            ...
            <div v-if="cart.result.count > 0">
              ...
              >
                ...
                <div
                    ...
                    :key="index"
                    :class="{ 'mb-10' : index !== cart.result.nurse_order.length - 1 }"
                    class="bg-white lg:bg-none px-3 lg:px-0 py-5 lg:py-0 rounded-lg"
                >
                  <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center gap-3">
              ...
              >
                ...
                <div
                    ...
                    :key="index"
                    :class="{ 'mb-10' : index !== cart.result.analyze_order.length - 1 }"
                    class="bg-white lg:bg-none px-3 lg:px-0 py-5 lg:py-0 rounded-lg"
                >
                  <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center gap-3">
        ...
        <div
            style="box-shadow: 0px 3px 10px 0px #0000000D;"
            class="w-full lg:w-1/4 p-5 bg-white rounded-lg h-max">
          <div v-if="cart.result">
            <div class="flex items-center justify-between mb-5 pb-5 border-b border-[#F6F6F7] w-full">
