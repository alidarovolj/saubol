  ...
  <div class="block md:flex justify-between gap-6">
    ...
    <div class="w-full md:w-4/5">
      <div v-if="!pending">
        ...
        >
          <div
            class="bg-red-500 rounded-full p-1 text-white w-14 h-14 flex items-center justify-center"
          >
        ...
        >
          ...
          >
            ...
            <div class="mb-3">
              <div v-if="result.data.img" class="relative h-full">
                <img
                  :src="result.data.img"
              ...
              >
                <p
                  class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-mainColor text-xl"
                >
                  {{ formattedName }}
                </p>
              </div>
            </div>
            <h1 v-if="!editMode" class="text-xl font-bold text-center my-3">
              {{ result.data.name }}
            </h1>
            <div class="block">
              <div class="flex items-center justify-between mb-3 md:mb-5">
                ...
                <div v-if="!editMode">
                  ...
                  <p v-else class="text-red-500">Необходимо заполнить</p>
                </div>
              </div>
              <div class="flex items-center justify-between mb-3 md:mb-5">
            ...
            <div v-if="editMode" class="w-1/2 mx-auto mt-3">
              <input
                v-model="form.name"
              ...
              />
              <p v-if="v$.name.$error && editMode" class="text-red-500 text-xs">
                Пожалуйста заполните данное поле
              </p>
            </div>
          </div>
          ...
          >
            <div
              class="flex items-center justify-between text-mainColor w-full"
            >
              <h1 class="text-black text-xl font-bold">Мои данные</h1>
              <div class="flex items-center gap-5">
                <div v-if="editMode" class="w-max">
                  <button
                    v-if="!loading"
                    type="submit"
            ...
            <div class="block md:flex justify-between gap-5">
              ...
              <div class="md:w-1/2 w-full flex flex-col justify-between gap-3">
                ...
                >
                  <IconMan size="40" class="text-mainColor" />
                  <div>
                    <p
                      :class="[
                    ...
                    <div v-if="doneIMT" class="font-medium">
                    ...
                    <p v-else class="text-red-500">Заполните вес и рост</p>
                  </div>
                </div>
                <div class="block md:flex justify-between gap-5">
                  <div
                    class="mb-3 md:mb-0 w-full bg-[#fe2c3945] p-3 rounded-lg flex items-center gap-3"
                  >
                    <IconRuler3 size="40" class="text-mainColor" />
                    <div>
                      ...
                      <div v-if="result.data.user_data">
                        <p v-if="!editMode" class="font-medium">
                ...
                <div
                  class="mb-3 md:mb-0 w-full bg-[#fe2c3945] p-3 rounded-lg flex items-center gap-3"
                >
                  <IconScaleOutline size="40" class="text-mainColor" />
                  <div>
                    ...
                    <div v-else class="text-red-500">Необходимо заполнить</div>
                  </div>
                </div>
                <div
                  class="w-full bg-[#fe2c3945] p-3 rounded-lg flex items-center gap-3"
                >
                  <IconMathXDivideY size="40" class="text-mainColor" />
                  <div>
                    <p class="text-[#9A9BA4] text-sm">ИМТ</p>
                    <p v-if="doneIMT" class="font-medium">
                      {{ doneIMT }}
                    </p>
                    <p v-else class="text-red-500">Заполните вес и рост</p>
                  </div>
